# Crear script SQL para insertar todas las marcas y modelos en Supabase
sql_completo = '''
-- ========================================
...
# Crear el archivo SQL completo
with open('insert_marcas_modelos_completo.sql', 'w', encoding='utf-8') as file:
    file.write(sql_completo)

print("📄 SCRIPT SQL COMPLETO CREADO:")
print("="*50)
print("✅ insert_marcas_modelos_completo.sql")
print("\n📊 INCLUYE:")
print("• 36 marcas principales (muestra)")
print("• +400 modelos en esta muestra")
print("• Script optimizado para PostgreSQL/Supabase")
print("• Verificación al final")

print("\n🎯 MARCAS EN LA MUESTRA:")
marcas_muestra = [
    "Abarth", "Acura", "Alfa Romeo", "Aston Martin", "Audi", "Bentley", 
    "BMW", "Chevrolet", "Citroën", "Cupra", "Dacia", "Ferrari", "Fiat",
    "Ford", "Honda", "Hyundai", "Jaguar", "Kia", "Lamborghini", 
    "Land Rover", "Lexus", "Maserati", "Mazda", "Mercedes-Benz",
    "MINI", "Nissan", "Opel", "Peugeot", "Porsche", "Renault",
    "SEAT", "Škoda", "Tesla", "Toyota", "Volkswagen", "Volvo"
]

for i, marca in enumerate(marcas_muestra, 1):
    if i % 6 == 1:
        print()
    print(f"{marca:<15}", end="")

print(f"\n\n🚀 PARA USAR:")
print("1. Ejecutar en Supabase SQL Editor")
print("2. Verificar con la query final")
print("3. Crear componente React selector")

print("\n❓ ¿Quieres que añada las marcas restantes o este listado te sirve?")

# Crear también un archivo con el componente React para usar las marcas
componente_react = '''
...
with open('BrandModelSelector_component.tsx', 'w', encoding='utf-8') as file:
    file.write(componente_react)

print("\n⚛️ COMPONENTE REACT CREADO:")
print("✅ BrandModelSelector_component.tsx")
print("\n🎯 FUNCIONALIDADES:")
print("• Carga marcas desde Supabase")
print("• Filtra modelos por marca seleccionada") 
print("• Hook personalizado para uso fácil")
print("• Estilos con Tailwind + Shadcn/ui")
print("• TypeScript completo")